...
def _run(run_id: str, receipt: ExecutionReceipt, *, recovery: bool = True) -> TestRun:
    return TestRun(
        ...
        runtime=SourceRevision("nhatnguyenquang1838-coder/DW-SuperApps", "runtime-lab/RP-CERT-001", SHA_A, SHA_A),
        subject=SourceRevision("nhatnguyenquang1838-coder/DW-SuperApps", "prove/RP-CERT-001/TC-RP-001", SHA_B, SHA_B),
        gwc_sha=SHA_C,
